...
class ModelConfig:
    ...
    class MDNConfig:
        ...
        nmdn_alpha: float = 2.
        # sequence distance infusion
        add_seq_distance: bool = False
        seq_distance_dim: Optional[int] = None
        seq_distance_cap: int = 100
        seq_separation_cutoff: Optional[int] = None
...
class DataConfig:
    ...
    class PrecomputedConfig:
        ...
        seq_save_path: Optional[str] = None
