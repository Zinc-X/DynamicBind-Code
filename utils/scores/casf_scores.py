...
import matplotlib
matplotlib.use('Agg')  # Non-GUI backend suitable for scripts
...
def plot_scatter_info(exp, cal, save_folder, save_name, title, total_time=None, original_size=None, 
    ...
    plt.annotate(annotate, xy=(0.05, 0.65), xycoords='axes fraction', bbox=dict(facecolor='lightgreen', edgecolor='green', boxstyle='round,pad=0.5'))
