...
class PhysDimeNet(nn.Module):
    ...
    def __init__(self, cfg: Config, energy_shift=None, energy_scale=None, ds: Dataset=None, **kwargs):
        ...
        for module, bond in zip(module_str_list, bonding_str_list):                                                         #                                                                
            ...
            if bond.lower() == "none" or module not in ["P", "P-noOut"]:                                              #                                                                                            
                continue                                                                                                    #                        
    ...
    def forward(self, data):
        ...
        for prop_name in ["pair_atom_prop", "edge_type"]:
    ...
    def gather_init_embeddings(self, data_batch):
        ...
        if "P" not in self.main_module_str and "P-noOut" not in self.main_module_str:
            return runtime_vars
